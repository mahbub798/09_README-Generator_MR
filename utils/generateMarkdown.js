...
function generateMarkdown(data) {
  return `
  # Title of the project: ${data.ProjectTitle}


  [![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/${data.GitHubUsername}/${data.ProjectTitle})
